        ...
        <div class="card">
            <header class="card-header">
                ...
                <div class="card-header-icon">
                    <b-button type="is-link" size="is-small" v-on:click="create">Tambah Pelanggan</b-button>
                </div>
            </header>
            <div class="card-content">
                ...
                <b-table
                    ...
                    :total="customers.meta ? customers.meta.total : 0" :per-page="customers.meta ? customers.meta.per_page : 0" :current-page="page"
                    v-on:page-change="nextPage" v-on:sort="sortTable">
                        ...
                        <b-table-column field="phone" label="No Telp" v-slot="props" sortable>
                            {{ props.row.phone }}
                        </b-table-column>
                        <b-table-column field="address" label="Alamat" v-slot="props" sortable>
                            {{ props.row.address }}
                        </b-table-column>
